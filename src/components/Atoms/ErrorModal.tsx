// components/Atoms/ErrorModal.tsx
...
useEffect(() => {
  ...
  return (
    <div className={`fixed top-4 right-4 z-[70] transition-all duration-300 transform ${
      ...
      <div className="bg-white border-l-4 border-red-500 rounded-xl shadow-2xl p-4 max-w-md">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h4 className="text-sm font-semibold text-slate-900 mb-1">Error</h4>
